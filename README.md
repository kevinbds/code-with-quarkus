...
- Pact Provider ([guide](https://quarkiverse.github.io/quarkiverse-docs/quarkus-pact/dev/provider-index.html)): Support for running a pact provider in Quarkus, including in Quarkus dev mode.
